...
namespace TopMenuLevel
{
    ...
    internal sealed class TestCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("9a4c81bf-fb0c-4ec0-8338-80f9b9dc7398");
        ...
        private TestCommand(Package package)
        {
            ...
            if (commandService != null)
            {
                ...
                var menuItem = new MenuCommand(this.MenuItemCallback, menuCommandID);
                 var menuCommandID2 = new CommandID(CommandSet, 0x200);
                var menuItem2 = new MenuCommand(this.MenuItemCallback2, menuCommandID2);
